...
INSERT INTO tasks (project_id, title, content, deadline, assignee_id, budget, status, skills)
VALUES (1, 'Task 1', 'project content', '2016-03-26 00:00:00+00:00', 'assignee', 10.5, 'todo', '{"Skill1"}');

INSERT INTO tasks (project_id, title, content, deadline, assignee_id, budget, status, skills)
VALUES (1, 'Task 1', 'project content', '2016-03-26 00:00:00+00:00', 'assignee', 10.5, 'todo', '{"Skill2"}');
